		...
		<div class="content">
            <ul class="ca-menu">
				<li>
                    ...
                    <li>
                        <a href="Crear_Marca.php">
                            <span class="ca-icon">&#43;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Marca</h2>
                    ...
                    <li>
                        <a href="#">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Marca</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Marca.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Marca</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Marca.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Marca</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:300px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				...
				{
					$consulta="SELECT id_marca,nombre_marca FROM marca_chuto WHERE id_marca='".$_POST["sel_ced"]."'";
					$res=consultar($consulta);
					$fila=mysql_fetch_array($res);
					$_POST["inputCedula"] =$fila[id_marca];
					$_POST["inputNombre"] =$fila[nombre_marca];
				}
						
				if(isset($_POST['b_modificar']))
				{
					$id_marca=$_POST["inputCedula"];
					$nombre_marca=$_POST["inputNombre"];
					$act="UPDATE marca_chuto SET id_marca='$id_marca',nombre_marca='$nombre_marca' WHERE id_marca='$id_marca'";
					if (!actualizar_bd($act)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error La Marca no se ha podido modificar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Marca ".$nombre_marca." ha sido Modificada exitosamente!";
						echo "</div>";
					}
				}			
			?>
			...
			<div class="control-group" style="position:absolute;left:215px;top:80px;width:198px;height:18px;line-height:18px;z-index:1;">
				<select name="sel_ced" class="span2">
					<?php
						$consulta="SELECT id_marca,nombre_marca FROM marca_chuto ORDER BY id_marca";
						$res=consultar($consulta);
						while($row=mysql_fetch_array($res))
						{
			...
			<div id="wb_Text5" for="inputNombre" style="position:absolute;left:50px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Nombre Marca
					</strong>
