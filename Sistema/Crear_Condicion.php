...
<head>
				...
				<li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Condición</h2>
                                <h3 class="ca-sub">Inserte un Nuevo Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Modificar_Condicion.php">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Condición</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Condicion.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Condición</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Condicion.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Condición</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:250px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			
			<div id="wb_Text3" style="position:absolute;left:15px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos de la Nueva Condicion
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo dupla" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			<div id="wb_Text4"  style="position:absolute;left:35px;top:120px;width:159px;height:19px;z-index:2;text-align:center;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Nombre Condici&oacute;n
					</strong>
				</span>
			</div>
			...
			<button type="submit" name="b_agregar" style="position:absolute;left:166px;top:200px;width:96px;height:25px;z-index:23;" class="btn-danger">Registrar</button>
				<?php
					if(isset($_POST["b_agregar"]))
					{
						...
						$insertar="INSERT INTO condicion_chuto (nombre_cond) VALUES('$nomdpto')";
						
						if (!actualizar_bd($insertar)) 
						{
    						$query ="SELECT nombre_cond FROM condicion_chuto WHERE nombre_cond='$nomdpto'";
    						$resultado=mysql_query($query) or die (mysql_error());
							if (mysql_num_rows($resultado)>0)
							{
								echo "<div class=\"alert alert-error\">";
  								echo "Error la condicion ya Existe!";
								echo "</div>";
							}
							else
							{
								echo "<div class=\"alert alert-error\">";
  								echo "Error la condicion no se ha podido crear!";
								echo "</div>";
							}
						}
						else
						{
							echo "<div class=\"alert alert-success\">";
  							echo "La condicion ".$nombre_cond." ha sido creado exitosamente!";
							echo "</div>";
						}
					}
				?>				
