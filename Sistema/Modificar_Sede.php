		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputCedula"] =$fila[id_sede];
					$_POST["inputNombre"] =$fila[nombre_sede];
				}
							
				if(isset($_POST['b_modificar']))
				{
					$id_sede=$_POST["inputCedula"];
					$nombre_sede=$_POST["inputNombre"];
					$act="UPDATE sede SET id_sede='$id_sede',nombre_sede='$nombre_sede' WHERE id_sede='$id_sede'";
					if (!actualizar_bd($act))
					{
						echo "<div class=\"alert alert-error\">";
						echo "Error la Sede no se ha podido modificar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
						echo "La Sede ".$nombre_sede." ha sido Modificado exitosamente!";
						echo "</div>";
					}
				}
			...
			<div id="wb_Text5" style="position:absolute;left:50px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
						Nombre Sede
					</strong>
