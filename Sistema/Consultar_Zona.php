	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Zona Comercial</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre de la Zona" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Zonas Comerciales Registradas</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_zona,nombre_zona FROM zona_com WHERE nombre_zona LIKE '%".$_POST["input_usu"]."%' ORDER BY id_zona ";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
				                           <td name='id' align='right'> <a  href=\"Modificar_Zona.php?id=$row[id_zona]&nombre=$row[nombre_zona]\">$row[id_zona]</a> </td>
                                           <td><a  href=\"Modificar_Zona.php?id=$row[id_zona]&nombre=$row[nombre_zona]\"> $row[nombre_zona] </td>
				                           </tr>";
								}
							}
				        ?>
