        ...
        <div class="container">
            <div class="content">
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="Crear_Estatus.php">
                            <span class="ca-icon">&#43;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Estatus</h2>
                    ...
                    <li>
                        <a href="#">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Estatus</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Estatus.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Estatus</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Estatus.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Estatus</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:300px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				...
				{
					$consulta="SELECT id_estatus,nombre_estatus FROM estatus WHERE id_estatus='".$_POST["sel_ced"]."'";
					$res=consultar($consulta);
					$fila=mysql_fetch_array($res);
					$_POST["inputCedula"] =$fila[id_estatus];
					$_POST["inputNombre"] =$fila[nombre_estatus];
				}
						
				if(isset($_POST['b_modificar']))
				{
					$id_estatus=$_POST["inputCedula"];
					$nombre_estatus=$_POST["inputNombre"];
					$act="UPDATE estatus SET id_estatus='$id_estatus',nombre_estatus='$nombre_estatus' WHERE id_estatus='$id_estatus'";
					if (!actualizar_bd($act))
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el estatus no se ha podido modificar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El estatus ".$nombre_estatus." ha sido Modificada exitosamente!";
						echo "</div>";
					}
				}
			...
			?>
				<div id="wb_Text3" style="position:absolute;left:30px;top:45px;width:430px;height:29px;z-index:0;text-align:left;">
					<span style="color:#000000;font-family:Arial;font-size:24px;">
						<strong>
							Datos de la Estatus a Modificar
						</strong>
					</span>
				</div>
				...
				<div class="control-group" style="position:absolute;left:215px;top:80px;width:198px;height:18px;line-height:18px;z-index:1;">
					<select name="sel_ced" class="span2">
						<?php
							$consulta="SELECT id_estatus,nombre_estatus FROM estatus ORDER BY id_estatus";
							$res=consultar($consulta);
							while($row=mysql_fetch_array($res))
							{
				...
				<div id="wb_Text5" for="inputNombre" style="position:absolute;left:40px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
					<span style="color:#000000;font-family:Arial;font-size:17px;">
						<strong>
							Nombre Estatus
						</strong>
