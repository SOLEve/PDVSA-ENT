	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:950px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				...
				{
					$eliminar="DELETE FROM cliente WHERE id_cli='".$_POST["inputCodigo"]."'";
					if (!actualizar_bd($eliminar)) 
					{
						echo "<div class=\"alert alert-error\">";
						echo "Error el Cliente no se ha podido eliminar!";
						echo "</div>";
					}else
					{
		...
		?>
			...
			<button type="submit" name="b_consultar" class="btn-inverse" style="position:absolute;left:140px;top:0px;width:90px;height:30px;line-height:18px;z-index:1;">Consultar</button></div>
			...
			<input type="text" name="inputCodigo" onkeyUp="return ValNumero(this);" style="position:absolute;left:215px;top:130px;width:198px;height:18px;line-height:18px;z-index:1;"value="<?php echo $_POST["inputCodigo"];?>">
			<div id="wb_Text4" style="position:absolute;left:5px;top:130px;width:80px;height:19px;z-index:2;text-align:center;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Codigo
					</strong>
			...
			<input type="text" name="inputNombre" style="position:absolute;left:215px;top:180px;width:198px;height:18px;line-height:18px;z-index:4;" value="<?php echo $_POST["inputNombre"];?>">
			<div id="wb_Text5" style="position:absolute;left:5px;top:180px;width:69px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
						Nombre
					</strong>
			...
			<input type="text"  name="inputRif" style="position:absolute;left:215px;top:230px;width:198px;height:18px;line-height:18px;z-index:6;"  value="<?php echo $_POST["inputRif"];?>">
			<div id="wb_Text6" style="position:absolute;left:5px;top:230px;width:69px;height:19px;z-index:5;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						RIF
					</strong>
			...
			<input type="text"  name="inputRazon" style="position:absolute;left:215px;top:280px;width:198px;height:18px;line-height:18px;z-index:7;"  value="<?php echo $_POST["inputRazon"];?>">
			<div id="wb_Text7" style="position:absolute;left:5px;top:280px;width:150px;height:38px;z-index:8;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Razón Social
					</strong>
			...
			<input type="text" name="inputDireccion" style="position:absolute;left:215px;top:330px;width:198px;height:18px;line-height:18px;z-index:9;"  value="<?php echo $_POST["inputDireccion"];?>">
			<div id="wb_Text8" style="position:absolute;left:5px;top:330px;width:63px;height:19px;z-index:10;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Dirección
					</strong>
			...
			<input type="text"  name="inputTelefono" onkeyUp="return ValNumero(this);" style="position:absolute;left:215px;top:380px;width:198px;height:18px;line-height:18px;z-index:11;"  value="<?php echo $_POST["inputTelefono"];?>">
			<div id="wb_Text9" style="position:absolute;left:5px;top:380px;width:48px;height:19px;z-index:19;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Teléfono
					</strong>
			...
			<input type="text" name="inputDistancia" onkeyUp="return ValNumero(this);" style="position:absolute;left:215px;top:430px;width:198px;height:18px;line-height:18px;z-index:13;"  value="<?php echo $_POST["inputDistancia"];?>">
			<div id="wb_Text12" style="position:absolute;left:5px;top:430px;width:220px;height:19px;z-index:14;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
			...
			<input type="text" name="inputTiempo" onkeyUp="return ValNumero(this);" style="position:absolute;left:215px;top:480px;width:198px;height:18px;line-height:18px;z-index:13;"  value="<?php echo $_POST["inputTiempo"];?>">
			<div id="wb_Text12" style="position:absolute;left:5px;top:480px;width:220px;height:19px;z-index:14;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:530px;width:129px;height:18px;line-height:18px;z-index:12;" value="<?php echo $_POST["inputTiempo"];?>">
			...
			<div id="wb_Text13" style="position:absolute;left:5px;top:530px;width:120px;height:19px;z-index:15;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Tipo Cliente
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:580px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputMayorista"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:580px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Mayorista
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:630px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputEstado"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:630px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Estado
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:680px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputMcpio"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:680px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Municipio
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:730px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputCiudad"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:730px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Ciudad
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:780px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputDtto"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:780px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Distrito
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:830px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputSede"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:830px;width:116px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Sede
					</strong>
			...
			<div class="control-group" style="position:absolute;left:215px;top:880px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputZona"];?>">
			...
			<div id="wb_Text14" style="position:absolute;left:5px;top:880px;width:150px;height:19px;z-index:16;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Zona Comercial
					</strong>
			...
			<button type="submit" name="b_eliminar" style="position:absolute;left:166px;top:920px;width:96px;height:25px;z-index:23;" class="btn-danger">Eliminar</button>
