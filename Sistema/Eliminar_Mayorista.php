		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_mayorista];
					$_POST["inputNombredpto"] =$fila[nombre_may];
				}
						
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM mayorista WHERE id_mayorista='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el mayorista no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El mayorista ha sido Eliminado exitosamente!";
						echo "</div>";
					}
				}
			...
			<div id="wb_Text3" style="position:absolute;left:37px;top:45px;width:450px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Datos del Mayorista a Eliminar
					</strong>
				</span>
			</div>
