	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;">
			<form  method="post"  action="#" class="form-horizontal" style="width:500px;height:600px;">
				<?php
					...
					{
						$consulta="SELECT id_usuario,nombre,apellido,telefono,email,login,clave,pregunta,respuesta,rol_id_rol,departamento_id_dpto FROM usuario WHERE id_usuario='".$_POST["sel_ced"]."'";
						$res=consultar($consulta);
					...
					if(isset($_POST['b_modificar']))
					{
						...
						$cor=$_POST["inputCorreo"];
						$log=$_POST["inputLogin1"];
						$cla=$_POST["inputClave"];
						$dpt=$_POST["inputDpto"];
						$rol=$_POST["inputRol"];
						$pre=$_POST["inputPregunta"];
						$res=$_POST["inputRespuesta"];
						$act="UPDATE usuario SET
							id_usuario='$ced',
							nombre='$nom',
							apellido='$ape',
							telefono='$tel',
							...
							login='$log',
							clave='$cla',
							departamento_id_dpto='$dpt',
							rol_id_rol='$rol',
							pregunta='$pre',
							respuesta='$res' 
							WHERE id_usuario='$cod1'";
									
						if (!actualizar_bd($act)) 
						{
							echo "<div class=\"alert alert-error\">";
							echo "Error el usuario no se ha podido modificar!";
							echo "</div>";
						}else
						{
							echo "<div class=\"alert alert-success\">";
							echo "El usuario ".$ced." ha sido Modificado exitosamente!";
							echo "</div>";
						}
					}
				...
				<div class="control-group" style="position:absolute;left:215px;top:80px;width:198px;height:18px;line-height:18px;z-index:1;">
					<select name="sel_ced" class="span2">
						<?php
							$consulta="SELECT id_usuario FROM usuario WHERE id_usuario='$_POST[inputCedula]'";
							$res=consultar($consulta);
							while($row=mysql_fetch_array($res))
							{
								if($row[id_usuario]!=1){echo"<option selected value=\"$row[id_usuario]\">$row[id_usuario]</option>";}
							}
					...
					<button type="submit" name="b_consultar" class="btn-inverse" style="position:absolute;left:140px;top:0px;width:90px;height:30px;line-height:18px;z-index:1;">
						Consultar
					</button>
				</div>
				...
				<input type="text" placeholder="V-00003300" name="inputCedula" style="position:absolute;left:215px;top:115px;width:198px;height:18px;line-height:18px;z-index:1;" value="<?php echo $_POST["inputCedula"];?>">
				...
				<input type="text"  name="inputApellido" style="position:absolute;left:215px;top:185px;width:198px;height:18px;line-height:18px;z-index:6;" value="<?php echo $_POST["inputApellido"];?>">
				...
				<input type="text"  name="inputTelefono" style="position:absolute;left:215px;top:220px;width:198px;height:18px;line-height:18px;z-index:7;"  value="<?php echo $_POST["inputTelefono"];?>">
				...
				<input type="email" placeholder="ejem correo@pdvsa.com"  name="inputCorreo" style="position:absolute;left:215px;top:255px;width:198px;height:18px;line-height:18px;z-index:9;" value="<?php echo $_POST["inputCorreo"];?>">
				...
				<input type="text"  name="inputLogin1"style="position:absolute;left:215px;top:290px;width:198px;height:18px;line-height:18px;z-index:11;" value="<?php echo $_POST["inputLogin1"];?>">
				...
				<input type="password" name="inputClave" style="position:absolute;left:215px;top:325px;width:198px;height:18px;line-height:18px;z-index:13;" value="<?php echo $_POST["inputClave"];?>">
				...
				<div class="control-group" style="position:absolute;left:215px;top:360px;width:129px;height:18px;line-height:18px;z-index:12;" value="<?php echo $_POST["inputRol"];?>" >
					<select name="inputRol" class="span2">
						<?php
							...
							$consulta="SELECT id_rol,nombre_rol FROM rol WHERE id_rol='$_POST[inputRol].'";
							$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo"<option selected value=\"$row[id_rol]\">$row[nombre_rol]</option>";
								} 
						?>
					</select>
				</div>
				...
				<div class="control-group" style="position:absolute;left:215px;top:400px;width:153px;height:20px;z-index:23;" value="<?php echo $_POST["inputDpto"];?>">
					<select name="inputDpto" class="span2">
						<?php
							...
							$consulta="SELECT id_dpto,nombre_dpto FROM departamento WHERE id_dpto='$_POST[inputDpto].'";
							$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo"<option selected value=\"$row[id_dpto]\">$row[nombre_dpto]</option>";
								} 
						?>
					</select>
				</div>
				...
				<div class="control-group" style="position:absolute;left:155px;top:440px;width:293px;height:20px;z-index:23;" value="<?php echo $_POST["inputPregunta"];?>">
					<select name="inputPregunta" class="span4" >
						...
						<option selected value="<?php echo $_POST["inputPregunta"];?>"><?php echo $_POST["inputPregunta"];?>			</option>
					</select>
				</div>
				...
				<input type="password"  style="position:absolute;left:155px;top:480px;width:288px;height:18px;line-height:18px;z-index:22;" name="inputRespuesta" value="<?php echo $_POST["inputRespuesta"];?>">
				...
				<button type="submit" name="b_modificar" style="position:absolute;left:166px;top:520px;width:96px;height:25px;z-index:23;" class="btn-danger">
						Modificar
				</button>
