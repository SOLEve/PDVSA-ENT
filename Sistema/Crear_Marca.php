		...
		<form  method="post"  action="#" class="form-horizontal" >
			<div id="wb_Text3" style="position:absolute;left:40px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos de la Nueva Marca
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo Sinotruk" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			<div id="wb_Text4"  style="position:absolute;left:55px;top:120px;width:150px;height:19px;z-index:2;text-align:center;">
			...
			<?php
				if(isset($_POST["b_agregar"]))
				{
					...
					$insertar="INSERT INTO marca_chuto (nombre_marca) VALUES('$nomdpto')";
					
					if (!actualizar_bd($insertar)) 
					{
						$query ="SELECT nombre_marca FROM marca_chuto WHERE nombre_marca='$nomdpto'";
						...
						{
							echo "<div class=\"alert alert-error\">";
							echo "Error la Marca no se ha podido crear!";
							echo "</div>";
						}
					}
					else
					{
						...
						echo " La Marca ".$nombre_marca." ha sido creado exitosamente!";
						echo "</div>";
					}
				}
			?>
