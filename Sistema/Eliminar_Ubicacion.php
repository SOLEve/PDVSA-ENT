		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_ubicacion];
					$_POST["inputNombredpto"] =$fila[nombre_ubicacion];
				}
						
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM ubicacion WHERE id_ubicacion='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error la Ubicacion no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Ubicacion ha sido Eliminado exitosamente!";
						echo "</div>";
					}
				}
			...
			<div id="wb_Text3" style="position:absolute;left:37px;top:45px;width:450px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Datos de la Ubicacion a Eliminar
					</strong>
				</span>
			</div>
			...
			<div id="wb_Text5"  style="position:absolute;left:85px;top:150px;width:69px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
						Nombre
					</strong>
