	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Marca</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre de la Marca" value="*" onClick="this.value='';">
                ...
                <table class="table table-striped" style="width: 100%; height: 15">
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_marca,nombre_marca FROM marca_chuto WHERE nombre_marca LIKE '%".$_POST["input_usu"]."%' ORDER BY id_marca";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
										<td name='id' align='right'> <a  href=\"Modificar_Marca.php?id=$row[id_marca]\">$row[id_marca]</a> </td>
                                        <td><a  href=\"Modificar_Marca.php?id=$row[id_marca]\"> $row[nombre_marca] </td>
				                        </tr>";
								}
							}
				        ?>
