		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_estatus];
					$_POST["inputNombredpto"] =$fila[nombre_estatus];
				}
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM estatus WHERE id_estatus='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el estatus no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El estatus ha sido Eliminado exitosamente!";
						echo "</div>";
					}
				}
			?>
			...
			<div id="wb_Text3" style="position:absolute;left:37px;top:45px;width:450px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Datos de la Estatus a Eliminar
					</strong>
				</span>
			</div>
			...
			<div id="wb_Text5"  style="position:absolute;left:35px;top:150px;width:169px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
						Nombre Estatus
					</strong>
