		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_zona];
					$_POST["inputNombredpto"] =$fila[nombre_zona];
				}
						
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM zona_com WHERE id_zona='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error La Zona no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Zona ha sido Eliminada exitosamente!";
						echo "</div>";
					}
				}
			?>
			...
			<div id="wb_Text4"  style="position:absolute;left:-15px;top:80px;width:250px;height:19px;z-index:2;text-align:center;">
			...
			<div id="wb_Text4"  style="position:absolute;left:5px;top:115px;width:200px;height:19px;z-index:2;text-align:center;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Código Zona Comercial
					</strong>
				</span>
			</div>
			...
			<div id="wb_Text5"  style="position:absolute;left:15px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
