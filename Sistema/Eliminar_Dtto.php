		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_dtto];
					$_POST["inputNombredpto"] =$fila[nombre_dtto];
				}
						
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM Distrito WHERE id_dtto='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar))
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el Distrito no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El Distrito ha sido Eliminado exitosamente!";
						echo "</div>";
					}
				}
			?>
