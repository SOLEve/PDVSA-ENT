	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Estatus</label>
				<div class="controls">
					<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre del Estatus" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Estatus Registrados</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_estatus,nombre_estatus FROM estatus WHERE nombre_estatus LIKE '%".$_POST["input_usu"]."%' ORDER BY id_estatus ";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
				                           <td name='id' align='right'> <a  href=\"Modificar_Estatus.php?id=$row[id_estatus]\">$row[id_estatus]</a> </td>
                                           <td><a  href=\"Modificar_Estatus.php?id=$row[id_estatus]\"> $row[nombre_estatus] </td>
				                           </tr>";
								}
							}
				        ?>
