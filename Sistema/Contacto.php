...
<head>
	...
	<div id="wb_Form1" style="position:absolute;left:280px;top:50px;width:1040px;height:350px;z-index:40;">
		<form  method="post"  action="#" enctype="multipart/form-data" class="form-horizontal" >

<pre style="font-family:'Arial';font-size:15px;">             
			<pre style="font-family:'Arial';font-size:20px;text-align:center;">  Contacto</pre>
			Para cualquier duda, falla, sugerencia o información se puede comunicar a traves de los siguientes medios:<br>
				
				<strong>1) Correo Electrónico:</strong> jesusegarcia@gmail.com / jesusegarcia@hotmail.com / jesuse.garcia@unet.edu.ve<br>
				<strong>2) Numero Telefónico:</strong> +58 424-712-8151<br>
				<strong>3) Twitter:</strong><a target= "_blank"href="https://twitter.com/Jezuz_Garcia"> @Jezuz_Garcia</a><br>
				<strong>4) Blog:</strong> <a target= "_blank" href="http://informaticaunet.blogspot.com/p/hola.html">Informaticaunet.blogspot.com</a>
