		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_ciudad];
					$_POST["inputNombredpto"] =$fila[nombre_ciudad];
				}
						
								
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM ciudad WHERE id_ciudad='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error la ciudad no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La ciudad ha sido Eliminada exitosamente!";
						echo "</div>";
					}
				}
				...
				<div id="wb_Text3" style="position:absolute;left:60px;top:45px;width:450px;height:29px;z-index:0;text-align:left;">
				...
				<div id="wb_Text5"  style="position:absolute;left:45px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
					<span style="color:#000000;font-family:Arial;font-size:17px;" >
						<strong>
							Nombre Ciudad
						</strong>
