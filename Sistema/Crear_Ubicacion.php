	   ...
	   <div class="container">
            <div class="content">
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="Modificar_Ubicacion.php">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
		...
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:15px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos de la Nueva Ubicaci&oacute;n
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo Fiscal&iacute;a" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			...
			<?php
				if(isset($_POST["b_agregar"]))
				{
					...
					$insertar="INSERT INTO ubicacion (nombre_ubicacion) VALUES('$nomdpto')";
					if (!actualizar_bd($insertar)) 
					{
    					$query ="SELECT nombre_ubicacion FROM ubicacion WHERE nombre_ubicacion='$nomdpto'";
    					$resultado=mysql_query($query) or die (mysql_error());
						if (mysql_num_rows($resultado)>0)
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error la Ubicaci&oacute;n ya Existe!";
							echo "</div>";
						}
						else
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error la Ubicaci&oacute;n no se ha podido crear!";
							echo "</div>";
						}
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Ubicacion ".$nombre_ubicacion." ha sido creado exitosamente!";
						echo "</div>";
					}
				}
			?>
