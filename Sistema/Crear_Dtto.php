		...
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:40px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos del Nuevo Distrito
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo Metropolitano" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			...
			<?php
				...
				{
					$nomdtto=$_POST["inputNomdpto"];						
					$insertar="INSERT INTO distrito (nombre_dtto) VALUES('$nomdtto')";
					if (!actualizar_bd($insertar)) 
					{
						$query ="SELECT nombre_dtto FROM distrito WHERE nombre_dtto='$nomdtto'";
    					$resultado=mysql_query($query) or die (mysql_error());
						if (mysql_num_rows($resultado)>0)
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error el distrito ya Existe!";
							echo "</div>";
						}
						else
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error el distrito no se ha podido crear!";
							echo "</div>";
						}
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El Distrito ".$nombre_dtto." ha sido creado exitosamente!";
						echo "</div>";
					}
				}
			?>				
