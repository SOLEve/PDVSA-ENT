	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre condicion</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre de la condicion" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de condicion Registradas</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_condicion,nombre_cond FROM condicion_chuto WHERE nombre_cond LIKE '%".$_POST["input_usu"]."%' ORDER BY id_condicion ";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
				                          <td name='id' align='right'> <a  href=\"Modificar_condicion.php?id=$row[id_condicion]\">$row[id_condicion]</a> </td>
                                          <td><a  href=\"Modificar_condicion.php?id=$row[id_condicion]\"> $row[nombre_cond] </td>
				                          </tr>";
								}
							}
				        ?>
