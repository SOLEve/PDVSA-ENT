        ...
        <div class="container">
            <div class="content">
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="Modificar_Mayorista.php">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
		...
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:30px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos del Nuevo Mayorista
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo PDV" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			...
			<button type="submit" name="b_agregar" style="position:absolute;left:166px;top:200px;width:96px;height:25px;z-index:23;" class="btn-danger">Registrar</button>
				<?php
					if(isset($_POST["b_agregar"]))
					{
						...
						$insertar="INSERT INTO mayorista (nombre_may) VALUES('$nomdpto')";
						if (!actualizar_bd($insertar)) 
						{
    						$query ="SELECT nombre_may FROM mayorista WHERE nombre_may='$nomdpto'";
    						$resultado=mysql_query($query) or die (mysql_error());
							if (mysql_num_rows($resultado)>0)
							{
								echo "<div class=\"alert alert-error\">";
  								echo "Error el mayorista ya Existe!";
								echo "</div>";
							}
							else
							{
								echo "<div class=\"alert alert-error\">";
  								echo "Error el mayorista no se ha podido crear!";
								echo "</div>";
							}
						}
						else
						{
							echo "<div class=\"alert alert-success\">";
  							echo "El Mayorista ".$nombre_may." ha sido creado exitosamente!";
							echo "</div>";
						}
					}
			?>
