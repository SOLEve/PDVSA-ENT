...
<head>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;">
		<form  method="post"  action="#"enctype="multipart/form-data" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:37px;top:45px;width:420px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos del Nuevo Conductor
					</strong>
				</span>
			</div>

			<input type="text" placeholder="V-00003300" name="inputCedula" style="position:absolute;left:215px;top:80px;width:198px;height:18px;line-height:18px;z-index:1;">
			...
			<input type="text"  name="inputApellido" style="position:absolute;left:215px;top:160px;width:198px;height:18px;line-height:18px;z-index:6;" >
			...
			<input type="text"  name="inputTelefono" style="position:absolute;left:215px;top:200px;width:198px;height:18px;line-height:18px;z-index:7;">
			...
			<input type="file" name="foto" style="position:absolute;left:215px;top:240px;width:198px;height:30px;line-height:18px;z-index:7;">
			<div id="wb_Text7" style="position:absolute;left:85px;top:240px;width:69px;height:38px;z-index:8;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Foto
					</strong>
			...
			<button type="submit" name="b_agregar" style="position:absolute;left:166px;top:300px;width:96px;height:25px;z-index:23;" class="btn-danger">Registrar</button>
			...
			<?php
				if(isset($_POST["b_agregar"]))
				{
					...
					$insertar="INSERT INTO Conductor (id_conductor,nombre,apellido,telefono) VALUES('$cedula','$nombre','$apellido','$telefono')";

					if (!actualizar_bd($insertar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el Conductor no se ha podido crear!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
						mkdir("fotos_conductor/".$_POST["inputCedula"]);
						$nombrefoto=$_FILES['foto']['name'];
						$ruta=$_FILES['foto']['tmp_name'];
						$consulta="SELECT id_conductor FROM conductor WHERE id_conductor=".$_POST["inputCedula"];
						$res=consultar1($consulta);
						$fila=mysqli_fetch_row($res); 
						$destino = "fotos_conductor/"."$fila[0]/".$nombrefoto;
						copy($ruta,$destino);
						mysql_query("update conductor set foto='$destino' WHERE id_conductor=".$_POST["inputCedula"]);
						echo "El Conductor ".$nombre." ha sido creado exitosamente!";
						echo "</div>";
					}
