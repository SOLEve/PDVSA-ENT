		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputCedula"] =$fila[id_edo];
					$_POST["inputNombre"] =$fila[nombre_edo];
				}
						
				if(isset($_POST['b_modificar']))
				{
					$id_edo=$_POST["inputCedula"];
					$nombre_edo=$_POST["inputNombre"];
					$act="UPDATE estado SET id_edo='$id_edo',nombre_edo='$nombre_edo' WHERE id_edo='$id_edo'";
					if (!actualizar_bd($act)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error el Estado no se ha podido modificar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El Estado ".$nombre_edo." ha sido Modificado exitosamente!";
						echo "</div>";
					}
				}
		?>
