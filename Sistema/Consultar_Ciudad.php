       ...
       <div class="container">
            <div class="content">
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="Crear_Ciudad.php">
                            <span class="ca-icon">&#43;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Ciudad</h2>
                                <h3 class="ca-sub">Inserte un Nuevo Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Modificar_Ciudad.php">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Ciudad</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Ciudad.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Ciudad</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Ciudad.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Ciudad</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Ciudad</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre de la ciudad" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Ciudades Registradas</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
					...
					<tbody>
						<?php
							if(isset($_POST['b_consultar']) || $_GET["pagina"]>0)
							{
								...
								if($_GET[input]=="todos")
								{
									$resultado = "SELECT *,COUNT(*) AS cant FROM ciudad ";
									$consulta = "SELECT  id_ciudad,nombre_ciudad FROM ciudad ORDER BY nombre_ciudad LIMIT $comienzo, $cant_reg";
									$input1="todos";
								}

								if($_POST['input_usu']==null && $_GET[input]!="todos")
								{
									$resultado = "SELECT *,COUNT(*) AS cant FROM ciudad WHERE nombre_ciudad LIKE '%".$_GET["input"]."%'";
									$consulta = "SELECT  id_ciudad,nombre_ciudad FROM ciudad WHERE nombre_ciudad LIKE '%".$_GET["input"]."%' ORDER BY nombre_ciudad LIMIT $comienzo, $cant_reg";
									$input1=$_GET[input];
								}				
										
								if($_POST['input_usu']!=null && $_POST['input_usu']!="todos")
								{
									$resultado = "SELECT *,COUNT(*) AS cant FROM ciudad WHERE nombre_ciudad LIKE '%".$_POST["input_usu"]."%'";
									$consulta = "SELECT  id_ciudad,nombre_ciudad FROM ciudad WHERE nombre_ciudad LIKE '%".$_POST["input_usu"]."%' ORDER BY nombre_ciudad LIMIT $comienzo, $cant_reg";
								...
								{
									echo " <tr>
											<td name='id' align='right'> <a  href=\"Modificar_Ciudad.php?id=$row[id_ciudad]\">$row[id_ciudad]</a> </td>
											<td><a  href=\"Modificar_Ciudad.php?id=$row[id_ciudad]\"> $row[nombre_ciudad] </td>
											</tr>";
								}
							}
						?>
			...
			<?php 
				...
				{ 
					echo "
					<li>
					<a href='Consultar_Ciudad.php?pagina=".($num_pag-1)."&input=".$_POST["input_usu"]."&input=$input1'>< Anterior</a>
					</li>"; 
				}
				...
				{ 
					...
					{ 
						echo "<li><a href='Consultar_Ciudad.php?pagina=$i&input=".$_POST["input_usu"]."&input=$input1'>$i</a></li> "; 
					} 
				} 
				...
				if(($num_pag + 1)<=$total_paginas) 
				{
					echo "
					<li>
					<a href='Consultar_Ciudad.php?pagina=".($num_pag+1)."&input=$input1'>Siguiente ></a>
					</li>";
				}
