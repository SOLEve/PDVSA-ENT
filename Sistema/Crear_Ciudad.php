		...
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:40px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos de la Nueva Ciudad
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo Gran Caracas" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			<div id="wb_Text4"  style="position:absolute;left:35px;top:120px;width:200px;height:19px;z-index:2;text-align:center;">
			...
			<?php
				if(isset($_POST["b_agregar"]))
				{
					...
					$insertar="INSERT INTO ciudad (nombre_ciudad) VALUES('$nomdpto')";

					if (!actualizar_bd($insertar))
					{
    					$query ="SELECT nombre_ciudad FROM ciudad WHERE nombre_ciudad='$nomdpto'";
    					$resultado=mysql_query($query) or die (mysql_error());
						if (mysql_num_rows($resultado)>0)
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error La Ciudad ya Existe!";
							echo "</div>";
						}
						else
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error La Ciudad no se ha podido crear!";
							echo "</div>";
						}
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Ciudad ".$nombre_ciudad." ha sido creado exitosamente!";
						echo "</div>";
					}
				}
			?>	
