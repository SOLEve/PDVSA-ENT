...
<head>
                ...
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Municipio</h2>
                                <h3 class="ca-sub">Inserte un Nuevo Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Modificar_Municipio.php">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Municipio</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Municipio.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Municipio</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Municipio.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Municipio</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:300px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div id="wb_Text3" style="position:absolute;left:30px;top:45px;width:500px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Ingrese Datos del Nuevo Municipio
					</strong>
				</span>
			</div>

			<input type="text" placeholder="Ejemplo Baruta" name="inputNomdpto" style="position:absolute;left:215px;top:120px;width:198px;height:18px;line-height:18px;z-index:1;">
			<div id="wb_Text4"  style="position:absolute;left:55px;top:120px;width:159px;height:19px;z-index:2;text-align:center;">
			...
			<?php
				...
				if(isset($_POST["b_agregar"]))
				{
					...
					$insertar="INSERT INTO municipio (nombre_mcpio) VALUES('$nomdpto')";

					if (!actualizar_bd($insertar)) 
					{
						$query ="SELECT nombre_mcpio FROM municipio WHERE nombre_mcpio='$nomdpto'";
    					$resultado=mysql_query($query) or die (mysql_error());
						if (mysql_num_rows($resultado)>0)
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error el Municipio ya Existe!";
							echo "</div>";
						}
						else
						{
							echo "<div class=\"alert alert-error\">";
  							echo "Error el Municipio no se ha podido crear!";
							echo "</div>";
						}
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "El Municipio ".$nombre_mcpio." ha sido creado exitosamente!";
						echo "</div>";
					}
				}
			?>
