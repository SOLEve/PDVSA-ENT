	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			...
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Mayorista</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre del Mayorista" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Mayoristas Registrados</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_mayorista,nombre_may FROM mayorista WHERE nombre_may LIKE '%".$_POST["input_usu"]."%' ORDER BY id_mayorista";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
				                           <td name='id' align='right'> <a  href=\"Modificar_Mayorista.php?id=$row[id_mayorista]&nombre=$row[nombre_may]\">$row[id_mayorista]</a> </td>
                                           <td><a  href=\"Modificar_Mayorista.php?id=$row[id_mayorista]&nombre=$row[nombre_may]\"> $row[nombre_may] </td>
				                           </tr>";
								}
							}
				        ?>
