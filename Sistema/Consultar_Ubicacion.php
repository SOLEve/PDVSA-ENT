	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Ubicaci&oacute;n</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre de la Ubicaci&oacute;n" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Ubicaci&oacute;n Registradas</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_ubicacion,nombre_ubicacion FROM ubicacion WHERE nombre_ubicacion LIKE '%".$_POST["input_usu"]."%' ORDER BY id_ubicacion ";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
										<td name='id' align='right'> <a  href=\"Modificar_Ubicacion.php?id=$row[id_ubicacion]\">$row[id_ubicacion]</a> </td>
                                        <td><a  href=\"Modificar_Ubicacion.php?id=$row[id_ubicacion]\"> $row[nombre_ubicacion] </td>
				                        </tr>";
								}
							}
				        ?>
