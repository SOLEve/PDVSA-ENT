	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:550px;z-index:40;overflow:auto;">
		<form  method="post"  action="#" class="form-horizontal" >
			<div class="control-group">
				<label class="control-label" for="inputCedula" >Nombre Tipo de Cliente</label>
					<div class="controls">
						<input type="text" name="input_usu" id="input_usu" value="Ingrese Nombre del Tipo de cliente" value="*" onClick="this.value='';">
			...
			<div class="control-group">
                <table class="table table-striped" style="width: 100%; height: 15">
  					<caption>
  						<h4>Lista de Tipos de Clientes Registrados</h4>
  					</caption>
  					<thead>
    					<tr>
      						<th>Codigo</th>
  					...
  					<tbody>
                        <?php
							...
							{
								$consulta="SELECT id_tipo,nombre_tipo FROM tipo_cliente WHERE nombre_tipo LIKE '%".$_POST["input_usu"]."%' ORDER BY id_tipo";
								$res=consultar($consulta);
								while($row=mysql_fetch_array($res))
								{
									echo " <tr>
				                          <td name='id' align='right'> <a  href=\"Modificar_Tipo.php?id=$row[id_tipo]&nombre=$row[nombre_tipo]\">$row[id_tipo]</a> </td>
                                          <td><a  href=\"Modificar_Tipo.php?id=$row[id_tipo]&nombre=$row[nombre_tipo]\"> $row[nombre_tipo] </a></td>
				                          </tr>";
								}
							}
				        ?>
