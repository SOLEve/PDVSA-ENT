		...
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				if(isset($_POST['b_consultar']))
				{
					...
					$_POST["inputIddpto"] =$fila[id_marca];
					$_POST["inputNombredpto"] =$fila[nombre_marca];
				}
						
								
				if(isset($_POST["b_eliminar"]))
				{
					$eliminar="DELETE FROM marca_chuto WHERE id_marca='".$_POST["inputIddpto"]."'";
					if (!actualizar_bd($eliminar)) 
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error la Marca no se ha podido eliminar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La marca ha sido Eliminada exitosamente!";
						echo "</div>";
					}
				}
			...
			<div id="wb_Text3" style="position:absolute;left:70px;top:45px;width:450px;height:29px;z-index:0;text-align:left;">
			...
			<div id="wb_Text4"  style="position:absolute;left:25px;top:115px;width:150px;height:19px;z-index:2;text-align:center;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Codigo Marca
					</strong>
			...
			<div id="wb_Text5"  style="position:absolute;left:50px;top:150px;width:150px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;">
					<strong>
						Nombre Marca
					</strong>
