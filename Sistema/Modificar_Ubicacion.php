	   ...
	   <div class="container">
            <div class="content">
                <ul class="ca-menu">
                    ...
                    <li>
                        <a href="Crear_Ubicacion.php">
                            <span class="ca-icon">&#43;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Agregar Ubicación</h2>
                    ...
                    <li>
                        <a href="#">
                            <span class="ca-icon">&#126;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Modificar Ubicación</h2>
                                <h3 class="ca-sub">Actualice un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Consultar_Ubicacion.php">
                            <span class="ca-icon">&#76;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consultar Ubicación</h2>
                                <h3 class="ca-sub">Búsqueda de un Registro</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="Eliminar_Ubicacion.php">
                            <span class="ca-icon">&#39;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Eliminar Ubicación</h2>
	...
	<div id="wb_Form1" style="position:absolute;left:530px;top:350px;width:460px;height:300px;z-index:40;">
		<form  method="post"  action="#" class="form-horizontal" >
			<?php
				...
				{
					$consulta="SELECT id_ubicacion,nombre_ubicacion FROM ubicacion WHERE id_ubicacion='".$_POST["sel_ced"]."'";
					$res=consultar($consulta);
					$fila=mysql_fetch_array($res);
					$_POST["inputCedula"] =$fila[id_ubicacion];
					$_POST["inputNombre"] =$fila[nombre_ubicacion];
				}
						
				if(isset($_POST['b_modificar']))
				{
					$id_ubicacion=$_POST["inputCedula"];
					$nombre_ubicacion=$_POST["inputNombre"];
					$act="UPDATE ubicacion SET id_ubicacion='$id_ubicacion',nombre_ubicacion='$nombre_ubicacion' WHERE id_ubicacion='$id_ubicacion'";
					if (!actualizar_bd($act))
					{
    					echo "<div class=\"alert alert-error\">";
  						echo "Error La Ubicacion no se ha podido modificar!";
						echo "</div>";
					}
					else
					{
						echo "<div class=\"alert alert-success\">";
  						echo "La Ubicacion ".$nombre_ubicacion." ha sido Modificada exitosamente!";
						echo "</div>";
					}
				}
			...
			<div id="wb_Text3" style="position:absolute;left:30px;top:45px;width:430px;height:29px;z-index:0;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:24px;">
					<strong>
						Datos de la Ubicaci&oacute;n a Modificar
					</strong>
				</span>
			</div>
			...
			<div class="control-group" style="position:absolute;left:215px;top:80px;width:198px;height:18px;line-height:18px;z-index:1;">
				<select name="sel_ced" class="span2">
					<?php
						$consulta="SELECT id_ubicacion,nombre_ubicacion FROM ubicacion ORDER BY id_ubicacion";
						$res=consultar($consulta);
						while($row=mysql_fetch_array($res))
						{
			...
			<div id="wb_Text5" for="inputNombre" style="position:absolute;left:30px;top:150px;width:200px;height:19px;z-index:3;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:17px;" >
					<strong>
						Nombre Ubicaci&oacute;n
					</strong>
				</span>
			</div>
